...
namespace manymove_object_manager
{
  ...
  private:
     ...
     * @return A response indicating acceptance or rejection of the cancel request.
     */
    rclcpp_action::CancelResponse handleRemoveCancel(const std::shared_ptr<RemoveGoalHandle> goal_handle);
     ...
     * @return A response indicating acceptance or rejection of the cancel request.
     */
    rclcpp_action::CancelResponse handleCheckExistCancel(const std::shared_ptr<CheckGoalHandle> goal_handle);
     ...
     * @return A response indicating acceptance or rejection of the cancel request.
     */
    rclcpp_action::CancelResponse handleAttachDetachCancel(const std::shared_ptr<AttachDetachGoalHandle> goal_handle);
     ...
     * @return A response indicating acceptance or rejection of the cancel request.
     */
    rclcpp_action::CancelResponse handleGetObjectPoseCancel(const std::shared_ptr<GetObjectPoseGoalHandle> goal_handle);
    ...
    createCollisionObject(const std::string &id, const std::string &shape, const std::vector<double> &dimensions,
    ...
    rclcpp::Publisher<moveit_msgs::msg::AttachedCollisionObject>::SharedPtr
        attached_collision_object_publisher_; ///< Publishes attached collision objects to the planning scene.
    ...
    rclcpp_action::Server<AttachDetachObject>::SharedPtr
        attach_detach_object_action_server_; ///< Action server for attaching and detaching objects from specified link.
