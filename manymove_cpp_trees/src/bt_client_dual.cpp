...
int main(int argc, char ** argv)
{
  ...
  std::string check_cylinder_obj_xml = buildObjectActionXML(
    "check_cylinder", createCheckObjectExists(
      "cylinder_id_key"));
  ...
  std::string init_mesh_obj_xml = fallbackWrapperXML(
    "init_mesh_obj", {check_mesh_obj_xml,
      add_mesh_obj_xml});
  ...
  std::string attach_obj_1_xml = buildObjectActionXML(
    "attach_obj_to_manipulate_1", createAttachObject(
      "object_to_manipulate_1_key", "tcp_frame_name_1_key",
  ...
  std::string remove_obj_2_xml = fallbackWrapperXML(
    ...
    {buildObjectActionXML(
        ...
        createRemoveObject("object_to_manipulate_2_key")),
      "<AlwaysSuccess />"});
  // ----------------------------------------------------------------------------
  ...
  blackboard->set(
    "pick_pre_transform_xyz_rpy_1_key", std::vector<double>{-0.002, 0.0, 0.0, 0.0,
      1.57, 0.0});
  blackboard->set(
    "approach_pick_pre_transform_xyz_rpy_1_key", std::vector<double>{-0.05, 0.0, 0.0,
      0.0, 1.57, 0.0});
  blackboard->set(
    "pick_post_transform_xyz_rpy_1_key", std::vector<double>{0.0, 0.0, -0.025, 3.14,
      0.0, 0.0});
  ...
  // Define the transformation and reference orientation
  blackboard->set(
    "pick_pre_transform_xyz_rpy_2_key", std::vector<double>{-0.002, 0.0, 0.0, 0.0,
      1.57, 0.0});
  blackboard->set(
    "approach_pick_pre_transform_xyz_rpy_2_key", std::vector<double>{-0.05, 0.0, 0.0,
      0.0, 1.57, 0.0});
  blackboard->set(
    "pick_post_transform_xyz_rpy_2_key", std::vector<double>{0.0, 0.0, -0.025, 3.14,
      0.0, 0.0});
  ...
  std::string check_reset_robot_1_xml =
    (rp_1.is_real ? fallbackWrapperXML(
      ...
      {check_robot_state_1_xml,
        reset_robot_state_1_xml}) : "<Delay delay_msec=\"250\">\n<AlwaysSuccess />\n</Delay>\n");
  ...
  std::string check_gripper_close_2_xml =
    (rp_2.is_real ? buildWaitForInput(
      rp_2.prefix, "WaitForSensor", "controller", 0,
      1) : "<Delay delay_msec=\"250\">\n<AlwaysSuccess />\n</Delay>\n");
  ...
  std::string check_reset_robot_2_xml =
    (rp_2.is_real ? fallbackWrapperXML(
      ...
      {check_robot_state_2_xml,
        reset_robot_state_2_xml}) : "<Delay delay_msec=\"250\">\n<AlwaysSuccess />\n</Delay>\n");
  ...
  std::string close_gripper_2_xml = sequenceWrapperXML(
    "CloseGripper", {signal_gripper_close_2_xml,
      check_gripper_close_2_xml,
      attach_obj_2_xml});
  std::string open_gripper_2_xml = sequenceWrapperXML(
    "OpenGripper", {signal_gripper_open_2_xml,
      detach_obj_2_xml});

  // Dedicated spawnable objects per robot:
  std::string spawn_graspable_objects_1_xml = sequenceWrapperXML(
    "SpawnGraspableObjects",
    {init_mesh_obj_xml});
  std::string spawn_graspable_objects_2_xml = sequenceWrapperXML(
    "SpawnGraspableObjects",
