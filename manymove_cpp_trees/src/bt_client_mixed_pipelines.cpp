...
int main(int argc, char **argv)
{
    ...
    std::vector<Move> scan_surroundings = {
        {rp.prefix, "joint", move_configs["CHOMP_max_move"], "", joint_look_sx},
        {rp.prefix, "joint", move_configs["PTP_max_move"], "", joint_look_dx},
    };

    // Sequences for Pick/Drop/Homing
    std::vector<Move> pick_sequence = {
        {rp.prefix, "pose", move_configs["mid_move"], "approach_pick_target_key"},
        {rp.prefix, "pose", move_configs["LIN_slow_move"], "pick_target_key"},
    };
    ...
    std::vector<Move> drop_sequence = {
        ...
        {rp.prefix, "pose", move_configs["LIN_slow_move"], "drop_target_key"},
    };

    std::vector<Move> home_position = {
        {rp.prefix, "pose", move_configs["LIN_mid_move"], "approach_drop_target_key"},
