...
- Install **[ROS2 Jazzy](https://docs.ros.org/en/ros2_documentation/jazzy/Installation.html)**
...
- If you prefer to install manually, you can follow the instructions on the jazzy branch of my fork of [xarm_ros2 on github](https://github.com/pastoriomarco/xarm_ros2/tree/jazzy).  
...
```
**Source ROS2 Jazzy** (skip if already sourced, modify this if you need to source from another dir):
```bash
...
- **Panda and Kinova Manipulators** 
  ...
  **WARNING:** *in jazzy branch moveit2_tutorials repo doesn't have a jazzy branch, and there could be some mismatch between ros-jazzy-moveit version and the tutorial's moveit2 version: to run the examples with Panda and Kinova robots you may need to install [moveit2_tutorials main branch](https://moveit.picknik.ai/main/doc/tutorials/getting_started/getting_started.html#download-source-code-of-moveit-and-the-tutorials), following all instruction sequence including the removal of the ros-jazzy-moveit* packages from the system.
