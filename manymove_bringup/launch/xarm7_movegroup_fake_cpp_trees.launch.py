...
def launch_setup(context, *args, **kwargs):
    ...
    attach_xyz = LaunchConfiguration('attach_xyz', default='"0 0 0.1"')
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('gripper_action_server', default_value='/xarm_gripper_traj_controller/follow_joint_trajectory', description='Name of the action server to control the gripper'),
        DeclareLaunchArgument('contact_links', default_value='["left_finger", "right_finger"]', description='List of links to exclude from collision checking'),
