"""Launch description for the xarm7 moveitcpp fake cpp trees scenario."""
...
def launch_setup(context, *args, **kwargs):
    """Configure launch actions for the xarm7 moveitcpp fake cpp trees scenario."""
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                default_value="/xarm_gripper_traj_controller/follow_joint_trajectory",
                description="Name of the action server to control the gripper",
            ),
            DeclareLaunchArgument(
                "contact_links",
                default_value='["left_finger", "right_finger"]',
