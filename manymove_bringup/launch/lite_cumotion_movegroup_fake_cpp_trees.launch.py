"""Launch description for the lite cumotion movegroup fake cpp trees scenario."""
...
def launch_setup(context, *args, **kwargs):
    """Configure launch actions for the lite cumotion movegroup fake cpp trees scenario."""
