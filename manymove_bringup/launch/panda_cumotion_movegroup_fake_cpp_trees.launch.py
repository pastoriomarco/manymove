"""Launch description for the panda cumotion movegroup fake cpp trees scenario."""
...
def launch_setup(context, *args, **kwargs):
    """Configure launch actions for the panda cumotion movegroup fake cpp trees scenario."""
    ...
    isaac_config_file_path = os.path.join(
        get_package_share_directory("isaac_ros_cumotion_moveit"), "config", "isaac_ros_cumotion_planning.yaml"
    )
    ...
    manymove_cpp_trees_node = Node(
        ...
        executable="bt_client_panda_cumotion",
