...
cp ${ISAAC_ROS_WS}/src/manymove/manymove_planner/config/isaac_ros/Dockerfile.manymove ${ISAAC_ROS_WS}/src/isaac_ros_common/docker/
cp ${ISAAC_ROS_WS}/src/manymove/manymove_planner/config/isaac_ros/build-manymove.sh ${ISAAC_ROS_WS}/src/isaac_ros_common/docker/scripts
cp ${ISAAC_ROS_WS}/src/manymove/manymove_planner/config/isaac_ros/.isaac_ros_common-config ${ISAAC_ROS_WS}/src/isaac_ros_common/scripts/
cp ${ISAAC_ROS_WS}/src/manymove/manymove_planner/config/isaac_ros/Dockerfile.aarch64 ${ISAAC_ROS_WS}/src/isaac_ros_common/docker/