...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('gripper_action_server', default_value='/uf850_gripper_traj_controller/follow_joint_trajectory', description='Name of the action server to control the gripper'),
