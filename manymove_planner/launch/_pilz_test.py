...
def launch_setup(context, *args, **kwargs):
    ...
    moveit_configs = (
        ...
        .pilz_cartesian_limits(file_path=get_package_share_directory("xarm_moveit_config") + "/config/lite6/pilz_cartesian_limits.yaml")
        # .moveit_cpp(file_path=get_package_share_directory("manymove_planner") + "/config/moveit_cpp.yaml")
    ).to_moveit_configs()

    # final_params = moveit_configs.to_dict()
    # print("DEBUG: Final MoveIt params:\n", yaml.dump(final_params))
